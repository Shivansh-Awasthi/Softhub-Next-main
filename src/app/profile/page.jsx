...
const ProfilePage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-950 py-8 px-4 sm:px-6 lg:px-8">
            {/* Banner */}
            <div className="w-full h-32 bg-blue-500 rounded-b-2xl mb-[-64px]"></div>
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="flex justify-center border-b border-gray-700 mb-8">
                    <button className="px-6 py-2 text-white border-b-2 border-blue-400 font-semibold">Overview</button>
                    <button className="px-6 py-2 text-gray-400 hover:text-white">Liked</button>
                    <button className="px-6 py-2 text-gray-400 hover:text-white">Game history</button>
                    <button className="px-6 py-2 text-gray-400 hover:text-white">Watchlist</button>
                </div>
                {/* Stats Cards */}
                <div className="mb-10">
